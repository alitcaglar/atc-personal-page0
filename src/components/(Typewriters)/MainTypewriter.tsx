      ...
      <div className="App text-6xl m-8 w-80 h-[45rem] bg-gradient-to-r from-teal-600 to-lime-600 bg-clip-text text-transparent">
        <Typewriter
          words={[
            ...
            "User experience at heart, this developer constantly learns to create ever-more captivating interfaces.",
            ...
            "Structured approach meets meticulous coding, this growth-oriented developer builds robust, scalable solutions.",
            "Systems thinking meets frontend expertise, Ali embraces learning to create seamless integrations.",
